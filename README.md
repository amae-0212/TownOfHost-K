...
[[Discord]](https://discord.gg/a99kVdbpPc)
...
## ブラックリストについて。
TOH-K様のアップデートによりSuperNewRolesと同様のブラックリストが有効になりました。<br>
TownOfHost-K様、SuperNewRoles様ありがとうございます。
...
**【絶対に読むんだ】**<br>
このModの利用をもって"処罰に値する利用方法"内で記載されている<br>
行動をしないと誓い,<br>
...
## 役職について
TOH-Kの役職を一部削除してしまうかもしれません。<br>すみません。<br>
...
このModの開発者
Githubのリンクはあとで書いときます。
・[Amae](https://github.com/amae-0212)
・[Mitsuya (Supporter)](https://github.com/Mitsuya-Supporter)

※本家TownOfHostおよびTownOfHost-K様の開発者はここでは省略させていただきます
#### クレジット
[Town Of Host](https://github.com/tukasa0001/TownOfHost)<br>
　TOHKのFork元の本家です。<br>TownOfHost様にある機能はTownOfHost-K様にも大体実装されています<br>
 
[Town Of Host-K](https://github.com/KYMario/TownOfHost-K)<br>
このModのフォーク元です。ありがとうございます。<br>
